...
- **Layer 4 vs. Layer 7**
  ...
  | Unit | Packet | Message |
  | Decision | <ul><li>Not based on the content of the packet.<li>Based on the source, destination IP addresses and ports recorded in the packet header.</ul> | <ul><li>Based on the content of the message.<ul><li>HTTP header</ul></ul> |
